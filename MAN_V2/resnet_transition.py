...
def ResNet18_F_T(num_classes):
    return ResNet_F(BasicBlock, [2,2,2,2], num_classes)
        
def ResNet18_T(num_classes):
    return ResNet(BasicBlock, [2,2,2,2], num_classes)
    
def ResNet34_T(num_classes):
    return ResNet(BasicBlock, [3,4,6,3], num_classes)

def ResNet50_T(num_classes):
    return ResNet(Bottleneck, [3,4,6,3], num_classes)

def ResNet101_T(num_classes):
    return ResNet(Bottleneck, [3,4,23,3], num_classes)

def ResNet152_T(num_classes):
